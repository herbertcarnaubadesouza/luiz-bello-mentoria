    ...
    <div className="relative h-96 overflow-hidden">
      ...
      <div className="relative h-full flex items-center justify-center">
        <div className="text-center text-white">
          <div className="mb-4">
            <h1 className="text-6xl font-bold mb-2 text-yellow-400 stroke-text">ARENA</h1>
          ...
          <div className="absolute bottom-4 right-4">
            <Button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-full">Comprar</Button>
          </div>
        </div>
      </div>
    </div>
